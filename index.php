...
<script>
        document.addEventListener("DOMContentLoaded", function () {
            const redirectUrl = "https://monkfish-app-2-vaaie.ondigitalocean.app/";
...
<a href="https://monkfish-app-2-vaaie.ondigitalocean.app/" id="accept-cookies" class="btn-primary">Accept</a>
</div>
            `;
